...
const newLogoHTML = `<a href="index.html" style="text-decoration: none; display: flex; align-items: center;">
    <img src="images/logo-1.png" alt="VinFast Logo" style="width: 40px; height: 40px; object-fit: contain;">
</a>`;
...
function updateLogoInPage(filePath) {
    try {
        ...
        // Replace the entire logo section (both icon and text) with just the clickable image
...
console.log('🔄 Updating logo to show only image without text and make it clickable...\n');
...
console.log('🔗 Logo is now clickable and links to homepage'); 